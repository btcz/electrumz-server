...
from electrumz.lib.script import (_match_ops, Script, ScriptError,
...
from electrumz.server.session import (ElectrumZ, AuxPoWElectrumZ,
                                      NameIndexElectrumZ, NameIndexAuxPoWElectrumZ)
...
class NameIndexMixin(NameMixin):
    ...
    def build_name_index_script(cls, name):
        ...
        from electrumz.lib.script import Script
...
class NameIndexAuxPoWMixin(NameIndexMixin, AuxPowMixin):
    SESSIONCLS = NameIndexAuxPoWElectrumZ
